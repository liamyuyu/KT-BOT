...
| Sprint 5 | 2026-01-29 ~ 2026-02-28 | 0/34 | 0% | ⏳ 计划中 | 对话历史、文档上传增强、引用优化、部署优化 |
| **总计** | - | **161/195** | **83%** | - | - |

**当前里程碑**: v0.2.0 - Enhanced Retrieval (已完成 - Sprint 2-3 100%)
...
### Sprint 5 (2026-01-29 ~ 2026-02-28) ⏳

**Sprint 目标**: 对话历史管理、文档上传增强、引用优化、部署优化 - 目标 v0.3.0

**计划用户故事**:
- [ ] Story 5.1: 对话历史管理 - Epic 4 (10点) ⭐ P0
- [ ] Story 5.2: 文档上传增强 - Epic 7 (8点) ⭐ P0
- [ ] Story 5.3: 引用溯源优化 - Epic 3 (8点) P1
- [ ] Story 5.4: Docker 部署优化 (5点) P1
- [ ] Story 5.5: 性能监控面板 - Epic 8 (3点) P2

**预估故事点数**: 34 点 | **预估周期**: 4 周 (15-20 工作日)

**关键交付物**:
- ✅ 完整的对话历史管理系统（保存、搜索、导出）
- ✅ 多格式文档上传（PDF/DOCX/TXT/MD/HTML）
- ✅ 优化的引用展示（关键词高亮、一键跳转）
- ✅ 生产就绪的 Docker 部署
- ✅ 基础性能监控面板
...
**技术设计**:
- 数据库模型: conversations + messages 表
- 12 个 REST API 端点
- 对话标题自动生成（关键词提取 + LLM）
- 全文搜索支持
- 多格式导出器（Markdown/JSON/PDF）
...
**技术设计**:
- 文档解析器（PyPDF2、python-docx、pdfplumber）
- 异步上传管理器
- SSE 实时进度推送
- 文件验证和大小限制
- 并发处理（最多 5 个文件）
